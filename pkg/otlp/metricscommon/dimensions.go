...
// NewDimensions creates a new Dimensions
func NewDimensions(name string, tags []string, host string, originID string) *Dimensions {
	return &Dimensions{name: name, tags: tags, host: host, originID: originID}
}
