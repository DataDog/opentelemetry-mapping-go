...
require (
	...
	github.com/DataDog/opentelemetry-mapping-go/pkg/internal/sketchtest v0.8.4
	github.com/DataDog/opentelemetry-mapping-go/pkg/otlp/attributes v0.8.4
	github.com/DataDog/opentelemetry-mapping-go/pkg/quantile v0.8.4
