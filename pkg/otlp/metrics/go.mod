...
require (
	...
	github.com/DataDog/opentelemetry-mapping-go/pkg/internal/sketchtest v0.12.0
	github.com/DataDog/opentelemetry-mapping-go/pkg/otlp/attributes v0.12.0
	github.com/DataDog/opentelemetry-mapping-go/pkg/quantile v0.12.0
